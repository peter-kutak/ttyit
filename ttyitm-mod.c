...
/*
 * prepisany SC16IS7xx tty serial driver - Copyright (C) 2014 GridPoint
...
static const struct sc16is7xx_devtype ttyit_devtype = {
	.name		= "ttyit",
	.nr_gpio	= 0,
	.nr_uart	= 1,
};
...
//	if (ret < 0) {
//		pr_err("probe Error regmap_read\n");
//		return -EPROBE_DEFER;
//  }
...
out_clk:
  ...
  printk(KERN_NOTICE pr_fmt("probe finish\n"));
	return ret;
}

static void sc16is7xx_remove(struct device *dev)
{
	struct sc16is7xx_port *s = NULL;
	int i;
  printk(KERN_NOTICE pr_fmt("remove\n"));
	...
	clk_disable_unprepare(s->clk);
  printk(KERN_NOTICE "ttyit: remove finish\n");
}

static const struct of_device_id __maybe_unused sc16is7xx_dt_ids[] = {
	{ .compatible = "ttyit",	.data = &ttyit_devtype, },
	{ }
};
...
//	regmap = devm_regmap_init_i2c(i2c, &regcfg);
  ...
  int ret = 0;
  //pre ttyit regmap nie je platny
  ret = sc16is7xx_probe(&i2c->dev, devtype/*, regmap*/, i2c->irq);
  pr_info("i2c probe finish\n");
	return ret;
}
...
static void sc16is7xx_i2c_remove(struct i2c_client *client)
{
  ...
  pr_info("i2c remove finish\n");
}

static const struct i2c_device_id sc16is7xx_i2c_id_table[] = {
	{ "ttyit",	(kernel_ulong_t)&ttyit_devtype, },
	{ }
};
...
MODULE_DESCRIPTION("ttyit i2c terminal driver");
